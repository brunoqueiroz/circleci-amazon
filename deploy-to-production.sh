...
scp -i brunosp.pem $CIRCLE_ARTIFACTS/modelo-front.tar ec2-user@54.94.154.180:/tmp/
...
ssh -t -i brunosp.pem ec2-user@54.94.154.180 'cd /tmp; sudo chmod 777 server.sh; ./server.sh'
